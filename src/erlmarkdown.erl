...
%
% Vendored from https://github.com/zotonic/zotonic/blob/master/apps/zotonic_core/src/markdown/markdown.erl
% Tests etc can be found here https://github.com/erlware/erlmarkdown
%
